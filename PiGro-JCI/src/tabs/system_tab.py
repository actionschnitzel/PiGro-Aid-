...
class SystemTab(ttk.Frame):
    def __init__(self, master):
        ...
        self.pi_set = ttk.LabelFrame(self, text="Raspberry Pi Settings", padding=20)
        ...
        for pi_settings_btn in pi_settings_btn_list:
            ...
            if pi_settings_btn == "Raspi Bookshelf":
                self.pi_button_x.config(image=self.color_icons.bookshelf_icon)

                if check_bookshelf() == False:
                    self.pi_button_x.configure(state=DISABLED)
            if pi_settings_btn == "Raspi Recommended\nSoftware":
                self.pi_button_x.config(image=self.color_icons.raspi_config_cli_icon)
            ...
            if pi_settings_btn == "Raspi Appearance\nSettings":
                self.pi_button_x.config(image=self.color_icons.raspi_pipanel)
            ...
            if pi_settings_btn == "Edit Config.txt":
                self.pi_button_x.config(image=self.color_icons.edit_config_txt_icon)

            if pi_settings_btn == "Raspi Mouse & Keyboard":
                self.pi_button_x.config(image=self.color_icons.mouse_keyboard_icon)
                if check_rc_gui() == False:
                    self.pi_button_x.configure(state=DISABLED)
            if pi_settings_btn == "DeskpiPro Control":
                self.pi_button_x.config(image=self.color_icons.deskpipro_icon)
                if check_deskpi_config() == False:
                    self.pi_button_x.configure(state=DISABLED)
            if pi_settings_btn == "Raspi SD Card Copier":
                self.pi_button_x.config(image=self.color_icons.sd_card_copier_icon)
                if check_rc_gui() == False:
                    self.pi_button_x.configure(state=DISABLED)
            if pi_settings_btn == "Raspi Printer Settings":
                self.pi_button_x.config(image=self.color_icons.printer_settings_icon)
                if check_rc_gui() == False:
                    self.pi_button_x.configure(state=DISABLED)
            if pi_settings_btn == "Raspi Desktop Settings":
                self.pi_button_x.config(image=self.color_icons.desktop_settings_icon)
                if check_rc_gui() == False:
                    self.pi_button_x.configure(state=DISABLED)
            if pi_settings_btn == "Raspi Screen Settings":
                self.pi_button_x.config(image=self.color_icons.screen_settings_icon)
                if check_rc_gui() == False:
                    self.pi_button_x.configure(state=DISABLED)
            if pi_settings_btn == "NeoFetch":
                self.pi_button_x.config(image=self.color_icons.neofetch_icon)
            ...
            if pi_settings_btn == "Gparted":
                self.pi_button_x.config(image=self.color_icons.gparted_icon)
            ...
            if pi_settings_btn == "FM God Mode":
                self.pi_button_x.config(image=self.color_icons.fm_godmode_icon)

            if pi_settings_btn == "dmesg --follow":
                self.pi_button_x.config(image=self.color_icons.boot_log_icon)
            ...
            if pi_settings_btn == "Xfce Settings":
                self.pi_button_x.config(image=self.color_icons.xfce_settings_icon)
                self.pi_button_x.configure(state=DISABLED)
                if get_desktop_environment() == "xfce":
                    self.pi_button_x.configure(state=NORMAL)

            if pi_settings_btn == "Bash History":
                self.pi_button_x.config(image=self.color_icons.bash_history_icon)

            if pi_settings_btn == "Cron Job":
                self.pi_button_x.config(image=self.color_icons.cron_job_icon)

            if pi_settings_btn == "Menu Settings\nAlacart":
                self.pi_button_x.config(image=self.color_icons.alacard_icon)
            ...
            if pi_settings_btn == "Gnome Tweaks":
                self.pi_button_x.config(image=self.color_icons.gnome_tweaks_icon)
                if check_gnome_tweaks() == False:
                    self.pi_button_x.configure(state=DISABLED)

            if pi_settings_btn == "Gnome Extensions":
                self.pi_button_x.config(image=self.color_icons.gnome_ext_icon)
                if get_desktop_environment() == "gnome":
                    self.pi_button_x.configure(state=NORMAL)
                else:
                    self.pi_button_x.configure(state=DISABLED)
            ...
            if pi_settings_btn == "Gnome Software\nUpdates":
                self.pi_button_x.config(image=self.color_icons.update_icon)
            ...
            if pi_settings_btn == "Gnome Settings":
                self.pi_button_x.config(image=self.color_icons.source_settings_icon)
