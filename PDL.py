...
# popen("apt-cache pkgnames > /home/timo/PiGro-Aid-/PDL/SomeFile.txt")

os.system(
    "xterm -e 'bash -c \"apt-cache pkgnames > ~/PiGro-Aid-/PDL/SomeFile.txt && exit; exec bash\"'"
)

os.system("dpkg --get-selections > ~/PiGro-Aid-/PDL/packages.list")
# os.system("sed -e s/install//g -i /home/timo/PiGro-Aid-/PDL/packages.list")
os.system(
    "xterm -e 'bash -c \"sed -e s/install//g -i ~/PiGro-Aid-/PDL/packages.list && exit; exec bash\"'"
)

os.system(
    "xterm -e 'bash -c \"cd ~/PiGro-Aid-/PDL/ && ls -d */ | cut -f1 -d'/' > apps.txt && exit; exec bash\"'"
)

os.system("find ~/PiGro-Aid-/PDL -type f -exec chmod +x {} \;")
...
def btop_plusplus():
    ...
    def top_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/bpytop/install.sh; exec bash\"'"
        )

    def top_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/bpytop/uninstall.sh; exec bash\"'"
        )
    ...
    bt_info = Label(
        bt_pp,
        text="Resource monitor that shows usage and stats for\nprocessor,memory, disks, network and processes.\n\ncommand: bpytop",
        justify="left",
        anchor="w",
        highlightthickness=0,
        borderwidth=0,
...
def argon_one():
    ...
    def argo_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Driver---Argon_One/install.sh; exec bash\"'"
        )

    def argo_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Driver---Argon_One/uninstall.sh; exec bash\"'"
        )
    ...
    ao_info = Label(
        ar,
        text="Driver for the Argon One Case.Including fan control.\nCommand: argonone-config",
        justify="left",
        anchor="w",
        highlightthickness=0,
        borderwidth=0,
...
def desk_pi():
    ...
    def dpp_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Driver---DeskPi_Pro/install.sh; exec bash\"'"
        )

    def dpp_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Driver---DeskPi_Pro/uninstall.sh; exec bash\"'"
        )
    ...
    dp_info = Label(
        dp,
        text="Driver for the Deskpi Pro Case.Including fan control.\nCommand: argonone-config",
        justify="left",
        anchor="w",
        highlightthickness=0,
        borderwidth=0,
...
def pop_pikiss():
    ...
    def pk_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Pikiss/install.sh; exec bash\"'"
        )

    def pk_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Pikiss/uninstall.sh; exec bash\"'"
        )
...
def pop_fanshim():
    ...
    def fs_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Driver---FanShim/install.sh; exec bash\"'"
        )

    def fs_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Driver---FanShim/uninstall.sh; exec bash\"'"
        )
...
def pop_piapps():
    ...
    def pia_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Pi-Apps/install.sh; exec bash\"'"
        )

    def pia_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Pi-Apps/uninstall.sh; exec bash\"'"
        )
...
def pop_tetris():
    ...
    def tet_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Tetris-CLI/install.sh; exec bash\"'"
        )

    def tet_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Tetris-CLI/uninstall.sh; exec bash\"'"
        )
...
def pop_albert():
    ...
    def alb_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Albert/install.sh; exec bash\"'"
        )

    def alb_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Albert/uninstall.sh; exec bash\"'"
        )
...
def pop_text():
    ...
    def subt_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Sublime_Text/install.sh; exec bash\"'"
        )

    def subt_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Sublime_Text/uninstall.sh; exec bash\"'"
        )
    ...
    st_info = Label(
        sltext,
        justify="left",
        text="Text Editor with a lot extra.",
        highlightthickness=0,
        borderwidth=0,
        background="#191925",
        foreground="white",
...
def pop_merge():
    ...
    def subm_inst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Sublime_Merge/install.sh; exec bash\"'"
        )

    def subm_uninst():
        os.system(
            "xterm -e 'bash -c \"~/PiGro-Aid-/PDL/Sublime_Merge/uninstall.sh; exec bash\"'"
        )
...
def inst_inf1():
    messagebox.showinfo(
        "You called for help?",
        "The list contains all available packages. Yes, even the ones you added yourself! You can either search with the mouse wheel or type the desired package into the search bar. Click on the desired packet and press install.",
    )
...
def inst_inf2():
    messagebox.showinfo(
        "What is it?",
        "The list contains all installed packages. ALL! You can either search with the mouse wheel or type the desired package into the search bar. Click on the desired packet and press uninstall.",
    )
...
def inst_inf3():
    messagebox.showinfo(
        "What is it?",
        "The list contains Git & PPA projects! Click on the desired packet and press install/uninstall.",
    )
...
############################################################################################IMAGES
tab_ip1 = Image.open("PDL/Albert/albert-icon.png")
ip01 = ImageTk.PhotoImage(tab_ip1)
il01 = Label(image=ip01)

tab_ip3 = Image.open("PDL/bpytop/logo.png")
ip03 = ImageTk.PhotoImage(tab_ip3)
il03 = Label(image=ip03)

tab_ip5 = Image.open("PDL/Driver---DeskPi_Pro/DeskpiPro_icon.png")
ip05 = ImageTk.PhotoImage(tab_ip5)
il05 = Label(image=ip05)

tab_ip6 = Image.open("PDL/Driver---FanShim/shim_icon.png")
ip06 = ImageTk.PhotoImage(tab_ip6)
il06 = Label(image=ip06)

tab_ip11 = Image.open("PDL/Pi-Apps/proglogo.png")
ip11 = ImageTk.PhotoImage(tab_ip11)
il11 = Label(image=ip11)

tab_ip13 = Image.open("PDL/Pikiss/logo_pikiss_header.png")
ip13 = ImageTk.PhotoImage(tab_ip13)
il13 = Label(image=ip13)

tab_ip17 = Image.open("PDL/Tetris-CLI/tetris.png")
ip17 = ImageTk.PhotoImage(tab_ip17)
il17 = Label(image=ip17)

tab_ip20 = Image.open("PDL/Driver---Argon_One/argon_icon.png")
...
tab_ip22 = Image.open("PDL/Sublime_Text/sublime_text.png")
ip22 = ImageTk.PhotoImage(tab_ip22)
il22 = Label(image=ip22)

tab_ip23 = Image.open("PDL/Sublime_Merge/sublime_merge.png")
ip23 = ImageTk.PhotoImage(tab_ip23)
il23 = Label(image=ip23)

# tab_ip24 = Image.open('PDL/btop++/btop.png')
...
#####################################################################TAB1
ess_lbl = Label(
    tab1, image=tp01, borderwidth=0, background="#191925", highlightthickness=0
)
...
shop_btn01 = Button(
    ...
    compound=TOP,
    font=("Helvetica", 11, "bold"),
    command=btop_plusplus,
    background="#191925",
).grid(column=0, row=0, pady=5, padx=5)
...
shop_btn01 = Button(
    ...
    command=argon_one,
    background="#191925",
).grid(column=1, row=0, pady=5, padx=5)
...
shop_btn05 = Button(
    ...
    background="#191925",
    command=pop_pikiss,
).grid(column=4, row=0, pady=5, padx=5)
...
shop_btn06 = Button(
    ...
    background="#191925",
    command=pop_piapps,
).grid(column=0, row=1, pady=0, padx=5)
...
shop_btn07 = Button(
    ...
    background="#191925",
    command=pop_tetris,
).grid(column=1, row=1, pady=1, padx=5)
...
shop_btn08 = Button(
    ...
    background="#191925",
    command=pop_albert,
).grid(column=2, row=1, pady=2, padx=5)

shop_btn09 = Button(
    ess_frame,
    width=105,
    image=ip23,
    text="Sublime Merge 64 Bit",
    anchor="n",
    highlightthickness=0,
    borderwidth=0,
    foreground="white",
    ...
    background="#191925",
    command=pop_merge,
).grid(column=3, row=1, pady=2, padx=5)

shop_btn10 = Button(
    ess_frame,
    width=105,
    image=ip22,
    text="Sublime Text 64 Bit",
    anchor="n",
    highlightthickness=0,
    borderwidth=0,
    foreground="white",
    ...
    background="#191925",
    command=pop_text,
).grid(column=4, row=1, pady=2, padx=5)
...
inst1_frame = Frame(
    tab2, borderwidth=0, background="#191925", highlightthickness=0, padx=10, pady=10
)
# ess_frame.place(x=3,y=250)
...
inst2_frame = Frame(
    tab2, borderwidth=0, background="#191925", highlightthickness=0, pady=10, padx=10
)
# ess_frame.place(x=3,y=250)
...
########################################################################git&ppa
inst3_p1 = """ xterm -e 'bash -c \"~/PiGro-Aid-/PDL/"""
inst3_p2 = """; exec bash\"' """
inst3_p3 = "/install.sh"

uninst3_p1 = """ xterm -e 'bash -c \"~/PiGro-Aid-/PDL/"""
uninst3_p2 = """; exec bash\"' """
uninst3_p3 = "/uninstall.sh"

inst3_frame = Frame(
    tab3, borderwidth=0, background="#191925", highlightthickness=0, pady=10, padx=10
)
# ess_frame.place(x=3,y=250)
